...
describe Weatherios do
  ...
  context 'requesting information on multiple cities ids works correctly' do
    ...
    it "should have a base as a string" do
      @weatherio.get_weather_list.each do |query|
        expect(@weatherio.get_weather_base(query)).to be_kind_of(String).or be_nil
      end
    end
    ...
    it "should have a humidity in the main section as an integer" do
      @weatherio.get_weather_list.each do |query|
        expect(@weatherio.get_weather_mainhum(query)).to be_kind_of(Integer).or be_kind_of(Float)
      end
    end
    ...
    it "should have a message in the sys section as a float" do
      @weatherio.get_weather_list.each do |query|
        expect(@weatherio.get_weather_sysmessage(query)).to be_kind_of(Float)
      end
    end
    ...
    it "should have a sunrise in the sys section as an integer" do
      @weatherio.get_weather_list.each do |query|
        expect(@weatherio.get_weather_syssunrise(query)).to be_kind_of(Integer)
      end
    end

    it "should have a sunset in the sys section as an integer" do
      @weatherio.get_weather_list.each do |query|
        expect(@weatherio.get_weather_syssunset(query)).to be_kind_of(Integer)
      end
    end
